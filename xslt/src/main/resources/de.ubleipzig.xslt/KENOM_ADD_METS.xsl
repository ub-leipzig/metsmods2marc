                    ...
                    <mets:fileSec>
                        <mets:fileGrp USE="ORIGINAL">
                            <mets:file ID="FILE_0001_ORIGINAL" MIMETYPE="image/jpeg">
                                <mets:FLocat xmlns:xlink="http://www.w3.org/1999/xlink" LOCTYPE="URL" xlink:href="{$identifier}_media/{$identifier}_vs.jpg"/>
                            </mets:file>
                            <mets:file ID="FILE_0002_ORIGINAL" MIMETYPE="image/jpeg">
                                <mets:FLocat xmlns:xlink="http://www.w3.org/1999/xlink" LOCTYPE="URL" xlink:href="{$identifier}_media/{$identifier}_rs.jpg"/>
                            </mets:file>
                        </mets:fileGrp>
                    </mets:fileSec>
