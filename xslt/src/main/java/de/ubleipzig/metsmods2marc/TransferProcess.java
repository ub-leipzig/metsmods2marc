...
public interface TransferProcess {
    ...
    static final String IMPORT_EXPORT_LOG_PREFIX = "org.fcrepo.importexport.audit";
    static final String BAGIT_CHECKSUM_DELIMITER = "  ";
     ...
     * would be stored
     */
    public static File fileForURI(final URI uri, final String sourcePath, final String
            destinationPath,
     ...
     */
    public static File directoryForContainer(final URI uri, final String sourcePath, final String
            destinationPath,
                                             final File baseDir) {
    ...
    public static Map<String, String> getSha1FileMap(final File baseDir, final Path manifestFile) {
        ...
        try (final Stream<String> stream = Files.lines(manifestFile)) {
            stream.forEach(l -> {
                ...
                final File file = Paths.get(baseDir.toURI()).resolve(
                        Paths.get(manifestTokens[1])).toFile();
